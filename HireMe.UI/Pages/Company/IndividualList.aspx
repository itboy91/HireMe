<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndividualList.aspx.cs" Inherits="HireMe.UI.Pages.Company.IndividualList" %>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlExperience" runat="server"  class="form-control"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="sel1">graduation country</label><br>
                                <asp:DropDownList ID="ddlGraduationCountry" runat="server"  class="form-control"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtMinimumSalary" runat="server"  class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="lib-panel">
                        <div class="row box-shadow">
                            ...
                            <div class="col-md-9">
                              ...
                              <div class="col-md-2" runat="server" id="divFavorite">
                              ...
                              <div class="col-md-3" runat="server" id="div1">
                                    <div class=" btn  btn-info">
                                        <asp:LinkButton runat="server" ID="lnkViewProfile" CommandArgument=' <%# Eval("Id") %>' OnCommand="lnkViewProfile_Command"> View </asp:LinkButton>
                                    </div>
                                </div>
                        </div>
                    </div>
