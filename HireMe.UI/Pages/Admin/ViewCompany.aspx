<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewCompany.aspx.cs" Inherits="HireMe.UI.Pages.Admin.ViewCompany" %>
    ...
    <div class="container">
        ...
        <div class="panel-body">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlIndustry" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                ...
                <div class=" row">
                    <div class="col-lg-12">
                                <asp:Button ID="btnCancel" runat="server" style="width: 150px; margin:-8px;" CssClass="btn btn-primary btn-lg" Text="Cancel" OnClick="btnCancel_Click" />
                    </div>
                </div>
            </div>
        </div>
